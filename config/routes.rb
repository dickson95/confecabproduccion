Rails.application.routes.draw do
  ...
  # Rutas de los lotes
  post 'lotes/:id/total_price' => 'lotes#total_price', :as => :lote_total_price # esta es un patch y pertenece a los lotes
  get "lotes/add_remote_data" => 'lotes#add_remote_data', :as => :add_remote_data # Esta ruta debe cambiar por que es una ruto por recurso
  get "lotes/view_datails/:id" => 'lotes#view_datails', :as => :view_datails # es método get, y parte de los lotes
  resources :lotes do
